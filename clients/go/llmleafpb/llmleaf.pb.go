...
// library under clients/ (Kotlin Multiplatform, Go, Rust, TypeScript, Zig, C#).
//
...
func (x *ContentPart) GetInputAudio() *InputAudioPart {
	if x != nil {
		if x, ok := x.Part.(*ContentPart_InputAudio); ok {
			return x.InputAudio
		}
	}
	return nil
...
type ContentPart_InputAudio struct {
	InputAudio *InputAudioPart `protobuf:"bytes,3,opt,name=input_audio,json=inputAudio,proto3,oneof"`
}
...
func (*ContentPart_InputAudio) isContentPart_Part() {}
...
func (x *InputAudioPart) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InputAudioPart) ProtoMessage() {}

func (x *InputAudioPart) ProtoReflect() protoreflect.Message {
	mi := &file_llmleaf_v1_llmleaf_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InputAudioPart.ProtoReflect.Descriptor instead.
func (*InputAudioPart) Descriptor() ([]byte, []int) {
	return file_llmleaf_v1_llmleaf_proto_rawDescGZIP(), []int{7}
}

func (x *InputAudioPart) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
func (x *InputAudioPart) GetFormat() string {
	if x != nil {
		return x.Format
	}
	return ""
...
type RerankRequest struct {
	...
	Documents []string               `protobuf:"bytes,3,rep,name=documents,proto3" json:"documents,omitempty"` // wire accepts a plain string or a structured object per element
	...
	TopN            *uint32 `protobuf:"varint,4,opt,name=top_n,json=topN,proto3,oneof" json:"top_n,omitempty"`
	ReturnDocuments *bool   `protobuf:"varint,5,opt,name=return_documents,json=returnDocuments,proto3,oneof" json:"return_documents,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *RerankRequest) GetReturnDocuments() bool {
	if x != nil && x.ReturnDocuments != nil {
...
type RerankResult struct {
	...
	Document       *string                `protobuf:"bytes,3,opt,name=document,proto3,oneof" json:"document,omitempty"` // present when return_documents == true
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *RerankResponse) GetUsage() *Usage {
	if x != nil {
		return x.Usage
	}
	return nil
...
type DecisionsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Model         string                 `protobuf:"bytes,1,opt,name=model,proto3" json:"model,omitempty"`
	State         string                 `protobuf:"bytes,2,opt,name=state,proto3" json:"state,omitempty"`                                                                                   // raw JSON string, object, or array; never double-encode
	Questions     map[string]string      `protobuf:"bytes,3,rep,name=questions,proto3" json:"questions,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // each value is a raw JSON noul, choice, or score question
	Extra         map[string]string      `protobuf:"bytes,4,rep,name=extra,proto3" json:"extra,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`         // raw JSON fields merged into the request object
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DecisionsRequest) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
func (x *DecisionsRequest) GetQuestions() map[string]string {
	if x != nil {
		return x.Questions
	}
	return nil
...
func (x *DecisionsRequest) GetExtra() map[string]string {
	if x != nil {
		return x.Extra
	}
	return nil
...
type DecisionsUsage struct {
	...
	Cost          *float64               `protobuf:"fixed64,3,opt,name=cost,proto3,oneof" json:"cost,omitempty"`                                                                     // provider-reported cost; zero is distinct from absent
	Extra         map[string]string      `protobuf:"bytes,4,rep,name=extra,proto3" json:"extra,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // unknown usage fields as raw JSON
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DecisionsUsage) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DecisionsUsage) GetOutputTokens() uint64 {
	if x != nil {
		return x.OutputTokens
	}
	return 0
...
func (x *DecisionsUsage) GetCost() float64 {
	if x != nil && x.Cost != nil {
		return *x.Cost
	}
	return 0
...
func (x *DecisionsUsage) GetExtra() map[string]string {
	if x != nil {
		return x.Extra
	}
	return nil
...
type DecisionsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Model         string                 `protobuf:"bytes,1,opt,name=model,proto3" json:"model,omitempty"`
	Answers       map[string]string      `protobuf:"bytes,2,rep,name=answers,proto3" json:"answers,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // raw JSON answers, including probabilities and legends
	Usage         *DecisionsUsage        `protobuf:"bytes,3,opt,name=usage,proto3" json:"usage,omitempty"`
	...
	Extra         map[string]string      `protobuf:"bytes,6,rep,name=extra,proto3" json:"extra,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // unknown response fields as raw JSON
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DecisionsResponse) GetAnswers() map[string]string {
	if x != nil {
		return x.Answers
	}
	return nil
...
func (x *DecisionsResponse) GetUsage() *DecisionsUsage {
	if x != nil {
		return x.Usage
	}
	return nil
...
func (x *DecisionsResponse) GetId() string {
	if x != nil && x.Id != nil {
		return *x.Id
	}
	return ""
...
func (x *DecisionsResponse) GetProvider() string {
...
func (x *DecisionsResponse) GetExtra() map[string]string {
	if x != nil {
		return x.Extra
	}
	return nil
...
const file_llmleaf_v1_llmleaf_proto_rawDesc = "" +
	...
	"\timage_url\x18\x02 \x01(\v2\x18.llmleaf.v1.ImageUrlPartH\x00R\bimageUrl\x12=\n" +
	"\vinput_audio\x18\x03 \x01(\v2\x1a.llmleaf.v1.InputAudioPartH\x00R\n" +
	"inputAudioB\x06\n" +
	"\x04part\"\x1e\n" +
	"\bTextPart\x12\x12\n" +
	...
	"\x05usage\x18\x04 \x01(\v2\x11.llmleaf.v1.UsageR\x05usage\"\xc2\x01\n" +
	"\rRerankRequest\x12\x14\n" +
	"\x05model\x18\x01 \x01(\tR\x05model\x12\x14\n" +
	"\x05query\x18\x02 \x01(\tR\x05query\x12\x1c\n" +
	"\tdocuments\x18\x03 \x03(\tR\tdocuments\x12\x18\n" +
	"\x05top_n\x18\x04 \x01(\rH\x00R\x04topN\x88\x01\x01\x12.\n" +
	"\x10return_documents\x18\x05 \x01(\bH\x01R\x0freturnDocuments\x88\x01\x01B\b\n" +
	"\x06_top_nB\x13\n" +
	"\x11_return_documents\"{\n" +
	"\fRerankResult\x12\x14\n" +
	"\x05index\x18\x01 \x01(\rR\x05index\x12'\n" +
	"\x0frelevance_score\x18\x02 \x01(\x02R\x0erelevanceScore\x12\x1f\n" +
	"\bdocument\x18\x03 \x01(\tH\x00R\bdocument\x88\x01\x01B\v\n" +
	"\t_document\"\x83\x01\n" +
	"\x0eRerankResponse\x12\x14\n" +
	"\x05model\x18\x01 \x01(\tR\x05model\x122\n" +
	"\aresults\x18\x02 \x03(\v2\x18.llmleaf.v1.RerankResultR\aresults\x12'\n" +
	"\x05usage\x18\x03 \x01(\v2\x11.llmleaf.v1.UsageR\x05usage\"\xc0\x02\n" +
	"\x10DecisionsRequest\x12\x14\n" +
	"\x05model\x18\x01 \x01(\tR\x05model\x12\x14\n" +
	"\x05state\x18\x02 \x01(\tR\x05state\x12I\n" +
	"\tquestions\x18\x03 \x03(\v2+.llmleaf.v1.DecisionsRequest.QuestionsEntryR\tquestions\x12=\n" +
	"\x05extra\x18\x04 \x03(\v2'.llmleaf.v1.DecisionsRequest.ExtraEntryR\x05extra\x1a<\n" +
	...
	"\x0eDecisionsUsage\x12!\n" +
	"\finput_tokens\x18\x01 \x01(\x04R\vinputTokens\x12#\n" +
	"\routput_tokens\x18\x02 \x01(\x04R\foutputTokens\x12\x17\n" +
	"\x04cost\x18\x03 \x01(\x01H\x00R\x04cost\x88\x01\x01\x12;\n" +
	"\x05extra\x18\x04 \x03(\v2%.llmleaf.v1.DecisionsUsage.ExtraEntryR\x05extra\x1a8\n" +
	"\n" +
	"ExtraEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\a\n" +
	"\x05_cost\"\xa1\x03\n" +
	"\x11DecisionsResponse\x12\x14\n" +
	"\x05model\x18\x01 \x01(\tR\x05model\x12D\n" +
	"\aanswers\x18\x02 \x03(\v2*.llmleaf.v1.DecisionsResponse.AnswersEntryR\aanswers\x120\n" +
	"\x05usage\x18\x03 \x01(\v2\x1a.llmleaf.v1.DecisionsUsageR\x05usage\x12\x13\n" +
	"\x02id\x18\x04 \x01(\tH\x00R\x02id\x88\x01\x01\x12\x1f\n" +
	"\bprovider\x18\x05 \x01(\tH\x01R\bprovider\x88\x01\x01\x12>\n" +
	"\x05extra\x18\x06 \x03(\v2(.llmleaf.v1.DecisionsResponse.ExtraEntryR\x05extra\x1a:\n" +
...
var file_llmleaf_v1_llmleaf_proto_goTypes = []any{
	...
	(*InputAudioPart)(nil),                 // 10: llmleaf.v1.InputAudioPart
	(*ContentParts)(nil),                   // 11: llmleaf.v1.ContentParts
	(*FunctionCall)(nil),                   // 12: llmleaf.v1.FunctionCall
	(*ToolCall)(nil),                       // 13: llmleaf.v1.ToolCall
...
var file_llmleaf_v1_llmleaf_proto_depIdxs = []int32{
	...
	10, // 4: llmleaf.v1.ContentPart.input_audio:type_name -> llmleaf.v1.InputAudioPart
	7,  // 5: llmleaf.v1.ContentParts.items:type_name -> llmleaf.v1.ContentPart
	12, // 6: llmleaf.v1.ToolCall.function:type_name -> llmleaf.v1.FunctionCall
	14, // 7: llmleaf.v1.ToolCallDelta.function:type_name -> llmleaf.v1.FunctionCallDelta
	0,  // 8: llmleaf.v1.ChatMessage.role:type_name -> llmleaf.v1.Role
